const imagemVisualicao = document.getElementById('imagem-visualizacao');
...
function trocarImagem(){
    ...
    imagemVisualicao.src = './imagens/opcoes-cores/'+ opcoesCores[corSelecionada].pasta +'/imagem-'+ imagemSelecionada +'.jpeg';
}
